  ...
  const services = [
      {
          ...
          image: "/assets/webdev.png?height=400&width=600",
          description:
      ...
      },
      {
          ...
          image: "/assets/mobileapp.png?height=400&width=600",
          description:
      ...
      {
          title: "UI/UX Designs",
          image: "/assets/UI.png?height=400&width=600",
          description:
      ...
      },
      {
          ...
          image: "/assets/testing.png?height=400&width=600",
          description:

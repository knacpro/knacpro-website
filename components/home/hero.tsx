...
export default function Hero() {
  return (
      <div className="h-[700px] bg-[#2A2D3A] text-white relative overflow-hidden pt-28">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="space-y-6 pr-10">
                      ...
                      <p className="text-gray-300 text-lg md:text-xl max-w-xl">
                          In today's increasingly digital world, cybersecurity
                          has become paramount. With the rapid expansion of
                          online activities,
                      </p>
                      <div className="flex flex-wrap gap-4 mt-8">
                          <button className="px-6 py-3 rounded-lg bg-gradient-to-r from-orange-500 to-pink-500 text-white flex items-center gap-2">
                              <span className="w-2 h-2 bg-orange-300 rounded-full"></span>
                              Request A Demo
                          </button>
                          <button className="px-6 py-3 rounded-lg bg-white text-[#2A2D3A] flex items-center gap-2">
                              <span className="p-1 bg-[#2A2D3A] rounded-full">
                                  <svg
                                      width="12"
                                      height="12"
                                      viewBox="0 0 12 12">
